...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference("Home.count") do
      post homes_url, params: { home: { day_construction: @home.day_construction, home_type: @home.home_type, pool: @home.pool } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { day_construction: @home.day_construction, home_type: @home.home_type, pool: @home.pool } }
